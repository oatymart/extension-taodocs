...
namespace oat\taoDocs\model\theme;
...
/**
 * Class TaodocsDefaultTheme
 *
 * @package oat\taoDocs\model\theme
 */
class TaodocsDefaultTheme extends DefaultTheme
{

    /**
     * Id of this extension
     */
    const EXTENSION_ID = 'taoDocs';


    /**
     * Theme's label
     */
    const THEME_LABEL = 'taoDocs default theme';


    /**
     * Theme's id, by default label without spec chars
     */
    const THEME_ID = 'taodocsDefaultTheme';
